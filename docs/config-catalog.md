...
- `@deepseek-ai/dsh-client-ui-plugin-browser` ([`packages/client/ui-plugin-browser/src/index.ts`](../packages/client/ui-plugin-browser/src/index.ts))
- `@deepseek-ai/dsh-client-ui-preset-editor` ([`packages/client/ui-preset-editor/src/index.ts`](../packages/client/ui-preset-editor/src/index.ts))
- `@deepseek-ai/dsh-client-ui-process-panel` ([`packages/client/ui-process-panel/src/index.ts`](../packages/client/ui-process-panel/src/index.ts))
...
- `@deepseek-ai/dsh-host-bundle-registry` ([`packages/host/bundle-registry/src/index.ts`](../packages/host/bundle-registry/src/index.ts))
- `@deepseek-ai/dsh-host-embeddings` ([`packages/host/embeddings/src/index.ts`](../packages/host/embeddings/src/index.ts))
- `@deepseek-ai/dsh-host-memory-browser` ([`packages/host/memory-browser/src/index.ts`](../packages/host/memory-browser/src/index.ts))
