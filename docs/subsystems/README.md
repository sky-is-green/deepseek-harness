...
| [models.md](models.md) | the local-model hosting seam: `ctx.models` catalog entries, hardware summaries, load-state tracking, and the download lifecycle over typed `models/*` events |
