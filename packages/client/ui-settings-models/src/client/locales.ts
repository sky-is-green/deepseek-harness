...
export const en = {
  ...
  retry: 'Retry',
  keyInput: 'API key',
  keyInputHint: 'Authenticates requests to this provider. Stored outside the settings file; leave blank to keep the stored key.',
  ...
  baseUrl: 'Base URL',
  baseUrlHint: 'Leave blank to use the provider default endpoint.',
  ...
  customDisplayNameHint: 'Shown in model pickers; falls back to the provider ID when empty.',
  customApi: 'API protocol',
  customApiHint: 'The wire protocol this route speaks.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  retry: '重试',
  keyInput: 'API 密钥',
  keyInputHint: '用于向该提供方认证请求；保存在设置文件之外，留空则保留已存储的密钥。',
  ...
  customDisplayNameHint: '在模型选择器中显示；留空时回退为 Provider ID。',
  customApi: 'API 协议',
  customApiHint: '该路由使用的接口协议。',
  customApiUnset: '未选择',
